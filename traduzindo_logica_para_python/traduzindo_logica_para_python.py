...
"""PERGUNTA 1: O input() sempre lê como texto (string).

Se não usar int() ou float(), não dá para fazer conta, pode dar erro ou o resultado fica errado.



PERGUNTA 2: Para ir de 1 até N:

range(1, N + 1)

Isso acontece porque o Python, inclui o começo, não inclui o final.

range(1, 5) → 1, 2, 3, 4

Por isso é necessrio o +1.
"""
